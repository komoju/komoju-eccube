...
class WebhookServiceTest extends TestCase
{
    ...
    public function testCapturedSuccess()
    {
        ...
        // getRepository(OrderStatus::class)->find(PAID) returns the paid status
        ...
        // Rebuild service with updated entityManager
        $this->service = new WebhookService(
            $this->entityManager,
            $this->orderStateMachine,
            $this->logService
    ...
    public function testCancelAlreadyCanceled()
    {
        ...
        // cancelOrder should return early — no state machine calls
