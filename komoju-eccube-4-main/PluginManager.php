...
class PluginManager extends AbstractPluginManager{
    ...
    public function disable(array $meta, ContainerInterface $container){
        ...
        $Payment = $paymentRepository->findOneBy(['method_class' => \Plugin\komoju\Service\Method\KomojuMultiPay::class]);
        if($Payment){
    ...
    protected function createTokenPayment(ContainerInterface $container){
        ...
        $Payment->setMethodClass(\Plugin\komoju\Service\Method\KomojuMultiPay::class);
        $entityManager->persist($Payment);
        $entityManager->flush();
    }
