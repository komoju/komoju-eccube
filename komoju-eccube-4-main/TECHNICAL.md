# Komoju EC-CUBE 4 プラグイン技術ドキュメント

## 概要
Komoju EC-CUBE 4 プラグインは、EC-CUBE 4.0〜4.1に対応したKomoju決済連携プラグインです。Komoju APIを利用し、注文・支払い・Webhook通知・管理画面での設定・ログ管理などを提供します。
...
## 注意事項
- EC-CUBE本体のバージョンに依存するため、4.0〜4.1以外は動作保証外
